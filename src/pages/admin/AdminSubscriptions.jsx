  ...
  return (
    <div className="admin-page-content">
      ...
      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(240px, 1fr))', gap: 20, marginBottom: 24 }}>
        {PLANS.map(plan => (
          <div key={plan.name} className="glass-card admin-card" style={{ border: `1px solid ${plan.color}28`, position: 'relative' }}>
            {plan.badge && (
      ...
      {[
        ...
        <div key={title} className="glass-card admin-card" style={{ marginBottom: 20 }}>
